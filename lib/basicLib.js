...
export async function runSafeScript(ns, script, value = "", value2 = "", value3 = "", value4 = "") {
	let pid=await runScript(ns,script, value, value2, value3, value4)
	while (ns.isRunning(pid)) { await ns.sleep(0) }
}

export async function execSafeScript(ns, script, server = "home", value = "", value2 = "", value3 = "", value4 = "") {
	let pid = 0;
	while (pid == 0) {
